...
const SingleCourse = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      content: 'Course content for Introduction to Microsoft Excel (Coursera)',
      tableOfContents: [
        {
          heading: 'Introduction to Microsoft Excel',
          // Embed link for Coursera instead of YouTube
          videoId: 'https://www.coursera.org/learn/excel',
        },
      ],
    },
